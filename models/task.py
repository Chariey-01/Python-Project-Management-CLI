...
class Task:
    ...
    def __init__(self, title, description, assigned_to=None):
        ...
        self.created_at = "2024-06-01 12:00:00"  # Example timestamp for task creation  
        self.updated_at = self.created_at  # Initialize updated_at with the same timestamp as created_at  
    ...
    def update_status(self, new_status):
        ...
        self.updated_at = "2024-06-01 12:00:00"  # Example timestamp for status update
    ...
    def assign_to(self, user):
        ...
        self.updated_at = "2024-06-01 12:00:00"  # Example timestamp for task assignment  
